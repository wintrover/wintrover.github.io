...
<div class="section">
  ...
  <p data-en="The application was deployed on Netlify using the following steps:" data-ko="애플리케이션은 다음 단계를 통해 Netlify에 배포되었습니다:"></p>
  <ol>
    <li data-en="Created a new site on Netlify and linked it to the GitHub repository." data-ko="Netlify에 새 사이트를 생성하고 GitHub 저장소에 연결했습니다."</li>
    <li data-en="Configured the build settings to use the correct build command and publish directory." data-ko="올바른 빌드 명령어와 게시 디렉토리를 사용하도록 빌드 설정을 구성했습니다."</li>
    <li data-en="Set up environment variables for the production environment." data-ko="프로덕션 환경을 위한 환경 변수를 설정했습니다."</li>
    <li data-en="Enabled automatic deploys from the main branch." data-ko="메인 브랜치에서 자동 배포를 활성화했습니다."</li>
  </ol>
</div>
