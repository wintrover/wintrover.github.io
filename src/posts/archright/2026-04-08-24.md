...
<article>
<img src="/images/verified.png" alt="VERIFIED output in terminal" style="max-width: 100%; border-radius: 8px;" />
<p style="text-align: center; margin-top: 0.5rem; font-size: 0.9rem; color: var(--text-muted);">The engine said "Verified." The code was broken.</p>
</article>
